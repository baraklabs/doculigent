...
const api: DoculigentApi = {
  ...
  cameraBubble: {
    ...
    setRecordingActive: (active, contentProtected, keepVisible) =>
      ipcRenderer.invoke(Channels.cameraBubble.setRecordingActive, active, contentProtected ?? false, keepVisible ?? false),
    setContentProtected: (protect) => ipcRenderer.invoke(Channels.cameraBubble.setContentProtected, protect),
    ...
    onRecordingActiveChanged: (callback) => {
      const listener = (_event: unknown, active: boolean, contentProtected: boolean) => callback(active, contentProtected);
  ...
  recordingDock: {
    ...
    setInteractive: (interactive) => ipcRenderer.invoke(Channels.recordingDock.setInteractive, interactive),
  ...
  recording: {
    ...
    onSaveCompleted: (callback) => {
      const listener = (_event: unknown, result: RecordingSaveResult) => callback(result);
  ...
  editProjects: {
    ...
    pickMediaFiles: () => ipcRenderer.invoke(Channels.editProjects.pickMediaFiles),
    updateMedia: (id, media) => ipcRenderer.invoke(Channels.editProjects.updateMedia, id, media),
    ...
    exportFrame: (exportId, frameBytes) => ipcRenderer.invoke(Channels.editProjects.exportFrame, exportId, frameBytes),
