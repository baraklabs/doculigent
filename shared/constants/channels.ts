...
export const Channels = {
  ...
  editProjects: {
    ...
    pickMediaFiles: "editProjects:pickMediaFiles",
    updateMedia: "editProjects:updateMedia",
    getMedia: "editProjects:getMedia",
    delete: "editProjects:delete",
    deleteMany: "editProjects:deleteMany",
    releaseMedia: "editProjects:releaseMedia",
    decodeAudioToWav: "editProjects:decodeAudioToWav",
    exportBegin: "editProjects:exportBegin",
    exportFrame: "editProjects:exportFrame",
    exportEnd: "editProjects:exportEnd",
